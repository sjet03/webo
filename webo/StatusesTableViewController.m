...
//    从账户中取出token
    ...
    NSString *AccessToken = delegate.accountManager.currentAccount.access_token;
//    使用get方法获取数据
    [manager GET:kFriendsTimeline parameters:@{@"access_token":AccessToken} success:^(AFHTTPRequestOperation *operation, id responseObject) {
         NSLog(@"statues请求成功%@",responseObject);
